...
class AsignarController extends Controller
{
    ...
    {
        $asignarModel = new AsignarModel();

        $disponibles = $asignarModel->obtenerDisponibles();
        $asignados   = $asignarModel->obtenerAsignados();

        $unidades   = $asignarModel->obtenerUnidades();
        $operadores = $asignarModel->obtenerOperadores();
        $rutas      = $asignarModel->obtenerRutas();
        $horarios   = $asignarModel->obtenerHorarios();

        return view('auth.asignar', compact(
    ...
    public function asignar(Request $request)
    {
        try {
            ...
            $resultado = $asignarModel->crearAsignacion([
